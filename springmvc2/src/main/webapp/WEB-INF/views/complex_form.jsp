						...
						<form action="handleform" method="post">
							<div class="form-group">
								<label for="exampleInputEmail1">Your Name</label> <input
									...
									placeholder="Please Enter Your Name" name="name"> <small
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Your Id</label> <input
									...
									placeholder=" Please Your Enter ID" name="id">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Your Email Id</label> <input
									...
									placeholder=" Please Your Enter Email" name="emailid">
							...
							<!-- <div class="form-group">
								<label>You DOB</label> <input type="text" class="form-control"
									placeholder="dd/MM/yyy" name="date">
